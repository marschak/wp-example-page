...
<div class="container pt-4">
	...
	<section>
		...
		<div class="row margin-t-1 d-none d-lg-flex">
			...
			<div class="col-sm-6 margin-b-1">
				<?php $pine_candle = wc_get_product('37865'); ?>
				<div class="home_category" data-aos="fade-up" data-aos-duration="300" style="background: center / cover no-repeat url('https://96north.com/wp-content/uploads/2024/01/forest-7150274_1920.jpg');">
					<p class="title"><?php echo $pine_candle->get_name(); ?></p>
					<a class="info" href="<?php echo esc_url(get_permalink('37865')); ?>">
						<div class="img2"><?php echo $pine_candle->get_image(); ?></div>
						<div class="desc">
							<h3>Luxury Soy Candles</h3>
							<p><span><?php echo $pine_candle->get_name(); ?></span></p>
							<p><?php echo $pine_candle->get_price_html(); ?></p>
							<button class="float-up home-btn-light">SHOP NOW</button>
						</div>
					</a>
				</div>
		...
		<div class="row margin-t-1 d-lg-none">
			...
			<div class="col-sm-6 margin-b-1">
				<a href="<?php echo esc_url(get_permalink('37865')); ?>" title="<?php the_title_attribute('1031'); ?>">
					<?php $pine_candle = wc_get_product('37865'); ?>
	...
	<section>
		<div class="row sticky margin-t-6 margin-b-3">
			<div class="col-12 col-md-6">
				<h2>Candles collection</h2>
			</div>
			<div class="col-12 col-md-6">
				<ul class="list_tick">
					<li>Premium Cotton Wicks</li>
					<li>Expertly Crafted Fragrances</li>
					<li>100% Soy Wax</li>
				</ul>
			</div>
